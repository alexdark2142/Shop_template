...
?>
  <tr id="user_<?php echo $user[0]; ?>" class="user">
        ...
        <div id="modal" class="modal d-flex align-items-center">
          <div class="content-modal">
            <div class="modal_header d-flex">
              <h1 class="col-11 modal-title d-flex align-items-center justify-content-center">Анкеты пользователя
                "<?php echo $user[1]; ?>"</h1>
            ...
            <div class="modal_body">
                ...
                <table class="table table-striped table-dark text-center table-modal">
                  ...
                  foreach ($people as $man) { ?>
                    <tr>
                      ...
                      <td>
                        <button id="deletePeople" onclick="deletePeople(this, <?php echo $man[5]; ?>)" class="btn-img">
                          <img src="../../img/cansel.png" alt="Удалить"></button>
                      </td>
                    </tr>
                  <?php } ?>
                  </tbody>
              ...
              <?php } else { ?>
                <h2 class="d-flex align-items-center justify-content-center">У этого пользователя нет анкет для
                  показа</h2>
              <?php } ?>
            </div>
          </div>
    ...
    <td>
      <button type="submit" onclick="getOptions(this, '<?php echo $user[0]; ?>')" class="btn btn-primary">OK</button>
    </td>
  </tr>
<?php
}
