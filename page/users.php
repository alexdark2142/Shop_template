...
<div id="users-container">
  <div class="page__header row d-flex align-items-center">
    ...
    <div class="col search input-group mb-3 ">
      <input id="search-user" value="<?php echo $text;?>" type="text" class="form-control" placeholder="Поиск" aria-label="Recipient's username" aria-describedby="basic-addon2">
      <div class="input-group-append">
        <button onclick="searchUsers(<?php echo $filter;?>)" class="btn btn-outline-secondary" type="button">Поиск</button>
      </div>
    </div>
  </div>
    ...
    <div class="users table-responsive">
      <?php  if (!empty($users)) { ?>
        ...
        <div class="btn-list d-flex justify-content-center">
          <button id="show-more-button" onclick="showMoreUsers(this, '<?php echo $text;?>', <?php echo $filter;?>)" data-page="1" data-max="<?php echo $amt; ?>" type="submit"  class="col btn btn-outline-info show_more">Показать еще...</button>
        </div>
      <?php
      }
      else {
